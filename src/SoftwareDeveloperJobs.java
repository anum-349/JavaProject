...
public class SoftwareDeveloperJobs extends Job {

    public SoftwareDeveloperJobs(){}
    
    public SoftwareDeveloperJobs(String title, String description, String company, String location, double salary, 
    ...
    public Job addJob() {
        ...
        Job job = new SoftwareDeveloperJobs(j_title, j_description, j_company, j_location, j_salary, j_Skills, j_qualification, j_experience);
        jobList.add(job);
