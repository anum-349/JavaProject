...
public class job_2 extends Job {
    // Constructor for the job_2 class
    public job_2(String title, String description, String company, String location, double salary, 
    ...
    public Job addJob() {
        ...
        Job job = new job_2(j_title, j_description, j_company, j_location, j_salary, j_Skills, j_qualification, j_experience);
        jobList.add(job);
